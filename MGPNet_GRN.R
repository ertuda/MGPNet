...
wilcox.test(as.numeric(cornnprot[,3]),as.numeric(cornepnprot[,3]))
...
wilcox.test(as.numeric(cornnprottu[,3]),as.numeric(cornepnprottu[,3]))
...
plot(density(rpall$PP_no[1:rno+1],na.rm=TRUE),lwd = 1.5,main='',xlab='',ylab='',
...
plot(density(rpall$PN_no[1:rno+1],na.rm=TRUE),lwd = 1.5,main='',xlab='',ylab='',
...
plot(density(rpall$NN_no[1:rno+1],na.rm=TRUE),lwd = 1.5,main='',xlab='',ylab='',
...
plotb = barplot(c(mean(rpall$PP_PP_sum[-1]),rpall$PP_PP_sum[1],
                ...
                ylab='Number of Cooccurence',col=c('gray','darkred'))
arrows(x0 = plotb,                      
...
title(main ='GRN PP-PP',ylab ="Frequency Density",
      xlab="Number of Cooccurence",font.lab=2,cex.lab=1.2,cex.main=1.3)
dev.off()
